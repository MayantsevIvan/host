...
//		pixiApp.loader.add('line6BuyLives.png',   urlWindBuyLives+'line6BuyLives.png');
		...
		pixiApp.loader.add('arrowLeft.png',               urlWindMenuLevels+'arrowLeft.png');
		pixiApp.loader.add('arrowRight.png',              urlWindMenuLevels+'arrowRight.png');
		pixiApp.loader.add('backgrStarLevel.png',         urlWindMenuLevels+'backgrStarLevel.png');
		pixiApp.loader.add('castle.png',                  urlWindMenuLevels+'castle.png');
		pixiApp.loader.add('cup.png',                     urlWindMenuLevels+'cup.png');
		pixiApp.loader.add('disBackgrBoxLevel.png',       urlWindMenuLevels+'disBackgrBoxLevel.png');
		pixiApp.loader.add('enBackgrBoxLevel.png',        urlWindMenuLevels+'enBackgrBoxLevel.png');
		pixiApp.loader.add('pointNextLevel.png',          urlWindMenuLevels+'pointNextLevel.png');
		pixiApp.loader.add('pointNextLevelClose.png',     urlWindMenuLevels+'pointNextLevelClose.png');
